...
EXAMPLE_SUBDIRS = amgx caliper ginkgo hiop petsc pumi sundials epic superlu moonolith
...
MFEM_REQ_LIB_DEPS = ENZYME SUPERLU MUMPS METIS FMS CONDUIT SIDRE LAPACK SUNDIALS EPIC\
